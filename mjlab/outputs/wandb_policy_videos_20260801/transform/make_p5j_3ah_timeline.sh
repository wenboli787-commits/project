...
frame_dir="${output_dir}/p5j_3ah_timeline_frames"
font_file="/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf"

specs=(
  "${root_dir}/cache/g1_tracking/wandb_checkpoints/p5jxr34o/videos/play/rl-video-step-0.mp4|05_04 ORIGINAL"
  "${output_dir}/05_04_gmr_3ah12ywt.mp4|47_01 TO 05_04 TRANSFER"
)
...
ffmpeg -loglevel error -y -framerate 1 -i "${frame_dir}/%02d.jpg" \
  -vf "tile=2x9" -frames:v 1 "${output_dir}/p5j_3ah_difference_timeline.jpg"
